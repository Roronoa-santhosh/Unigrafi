...
async function Navbar() {
  ...
  return (
    <>
      <header className="flex justify-between p-5 bg-bg-surface border border-bg-border fixed w-full z-50 ">
        <div>
          <h1 className="font-display text-base font-bold tracking-tight sm:text-4xl">
